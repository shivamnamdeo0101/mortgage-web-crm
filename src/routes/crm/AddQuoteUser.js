...
function AddQuoteUser() {
	...
	const [quote, set_quote] = useState({quote_comment:"Your comment",quote_status:"Active",process_status:""});
						...
						<div className="bg_white">
							...
							
							{
								contact_id ? 
									<div className="grid_quote_head">
								<h3>Contact </h3>
								<p><GetEmail contact_id={contact_id}/></p>
							</div>
							:
							<div>
							</div>
							...
							<div className="quote_milestone_list margin_top">
								...
								<div className="quote_action_list">
									...
									{
										contact_id &&
											<div className="action_button"onClick={()=>window.open("/add_quote_user/"+`${contact_id}`,"blank")}>
									...
									<div className="action_button" onClick={()=>history.push("/view_contact/"+`${contact_id}`)}>
										<PermContactCalendarIcon />
										<p>Contact</p>
									</div>
									<div className="action_button" onClick={()=>history.push("/add_task_user/"+`${contact_id}`)}>
										<ListAltIcon />
										<p>Task</p>
									</div>
							...
							<form   id="quote_form" onSubmit={on_add}>
										...
										<div className="grid_form_head">
											...
											<div className="quote_form_comp">
												...
												<label>Select User</label>
														...
														<select  required disabled={contact_id ? true : false} value={contact_id} name="user" onChange={handleChange}>
